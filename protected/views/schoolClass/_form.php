...
<div class="module_content">
	...
	<fieldset class="left">
		...
		<?php echo CHtml::activeDropDownList($model, 'grade_id_fk', $this->school_grade,array('id'=>'slSchoolClass','autofocus'=>'true'));  ?>
		<?php echo $form->error($model,'grade_id_fk'); ?>
	</fieldset>
	<fieldset class="right">
		<?php echo $form->labelEx($model,'class_name'); ?>
		<?php echo $form->textField($model,'class_name',array('size'=>60,'maxlength'=>100,'id'=>'txtClassName')); ?>
