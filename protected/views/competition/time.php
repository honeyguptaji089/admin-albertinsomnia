...
<div class="module width_3_quarter">
	<div class="header">
		<h3 class="tabs_involved">Competition Timeing in Different Areas</h3>
	</div>
	<div class="module_content">
		<div class="form">
		<fieldset >
			<label>Competition Name : </label>
			<span><?php echo $model->competition_name; ?></span>
		</fieldset>
		<?php
		...
		?>
			<fieldset >
				<label>Competition Time at Your Location : </label>
			...
			<tbody>
				<?php		
					foreach ($this->timearray as $key => $value)
					{
						...
						echo "	<td>".$key."</td>";
						echo "	<td>".$value."</td>";
						echo "	<td>".date('F j, Y, g:i A',strtotime($this->gmtCompetitionTime . $value))."</td>";
						echo "</tr>";
					}
