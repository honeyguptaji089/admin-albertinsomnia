...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('navigation_url')); ?>:</b>
	<?php echo CHtml::encode($data->navigation_url); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('sponsor_id_fk')); ?>:</b>
	<?php echo CHtml::encode($data->sponsor_id_fk); ?>
	<br />
