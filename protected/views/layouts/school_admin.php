...
<aside id="sidebar" class="column">
	...
	<ul class="toggle">
		...
		$this->widget('zii.widgets.CMenu', array(
			'items'=>array(
						array('label'=>'Create School Class', 'url'=>array('SchoolClass/create')),
						array('label'=>'View School Class', 'url'=>array('SchoolClass/admin')),
						array('label'=>'Create Player', 'url'=>array('player/create')),
						array('label'=>'View Player', 'url'=>array('player/admin')),
						array('label'=>'Upload Player', 'url'=>array('player/upload')),
						array('label'=>'Create Teacher', 'url'=>array('teacher/create')),
						array('label'=>'View Teacher', 'url'=>array('teacher/admin')),
						array('label'=>'Profile', 'url'=>array('school/update&id='.$school_id)),
						array('label'=>'Change Password', 'url'=>array('UserInfo/update','id'=>$user_id_fk)),
						array('label'=>'Statistics', 'url'=>array('Reporting/school')),
