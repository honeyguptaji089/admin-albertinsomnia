...
<aside id="sidebar" class="column">
	...
	<ul class="toggle">
		...
		$this->widget('zii.widgets.CMenu', array(
			'items'=>array(
						array('label'=>'Create Group', 'url'=>array('SchoolGroup/create')),
						array('label'=>'View Group', 'url'=>array('SchoolGroup/admin')),
						array('label'=>'Create Game Level', 'url'=>array('GameLevel/create')),
						array('label'=>'View Game Level', 'url'=>array('GameLevel/admin')),
						array('label'=>'Create Test', 'url'=>array('test/create')),
						array('label'=>'View Test', 'url'=>array('test/admin')),
						array('label'=>'Profile', 'url'=>array('teacher/update','id'=>$teacher_id)),
						array('label'=>'Change Password', 'url'=>array('UserInfo/update','id'=>$user_id_fk)),
						array('label'=>'Statistics', 'url'=>array('Reporting/teacher')),
